...
import { addIndexedArgsToEvent, useDeployedContractInfo } from "~~/hooks/daobox";
import { ContractAbi, ContractName, UseScaffoldEventConfig } from "~~/utils/daobox/contract";
