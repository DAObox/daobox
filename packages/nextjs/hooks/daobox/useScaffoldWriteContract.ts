...
import { useDeployedContractInfo, useTransactor } from "~~/hooks/daobox";
...
export const useScaffoldWriteContract = <TContractName extends ContractName>(
  ...
  >(
    ...
    if (!deployedContractData) {
      notification.error("Target Contract is not deployed, did you forget to run `bun deploy`?");
      return;
    }
